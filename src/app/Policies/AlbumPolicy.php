...
class AlbumPolicy
{
     ...
     *
     * @param User|null $user  The authenticated user, if any
     * @param Album     $album The model to view
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user  The authenticated user, if any
     * @param Album     $album The model to update
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user  The authenticated user, if any
     * @param Album     $album The model to delete
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user  The authenticated user, if any
     * @param Album     $album The model to restore
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user  The authenticated user, if any
     * @param Album     $album The model to permanently delete
     *
     * @return bool
     */
