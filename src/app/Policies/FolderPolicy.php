...
class FolderPolicy
{
     ...
     *
     * @param User|null $user   The authenticated user, if any
     * @param Folder    $folder The model to view
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user   The authenticated user, if any
     * @param Folder    $folder The model to update
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user   The authenticated user, if any
     * @param Folder    $folder The model to delete
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user   The authenticated user, if any
     * @param Folder    $folder The model to restore
     *
     * @return bool
     */
     ...
     *
     * @param User|null $user   The authenticated user, if any
     * @param Folder    $folder The model to permanently delete
     *
     * @return bool
     */
