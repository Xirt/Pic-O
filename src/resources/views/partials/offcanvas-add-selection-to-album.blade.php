<div class="offcanvas offcanvas-bottom offcanvas-bottom-sm" tabindex="-1" id="offcanvas-add-selection-to-album" aria-labelledby="offcanvasAddSelectionToAlbumLabel">

    <div class="offcanvas-inner bg-white rounded-top mx-auto w-100 px-3">

        <div class="offcanvas-header">

            <h5 class="offcanvas-title" id="offcanvasAddSelectionToAlbumLabel">
        ...
        <div class="offcanvas-body small overflow-visible">
            ...
            <form action="" method="POST" id="addSelectionToAlbumForm" class="w-100">
            @csrf
                ...
                <div class="mb-1 row align-items-center">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="position-relative m-0" data-tpl-option="albumOption" data-tpl-empty="noAlbumOption" id="addSelectionAlbum">
